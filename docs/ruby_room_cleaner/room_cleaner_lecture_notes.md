...
### 2. Tiny Instacart!
  ...
  2. Using the tools and concepts from [`room_cleaner.rb`](/room_cleaner.rb), construct a self-running terminal program that successfully runs through your intended workflow.
