...
### 2. Tiny Instacart!
  ...
  2. Using the tools and concepts from [the completed room cleaner program](../lectures/ruby_room_cleaner/room_cleaner_complete.rb), construct a self-running terminal program that successfully runs through your intended workflow.
